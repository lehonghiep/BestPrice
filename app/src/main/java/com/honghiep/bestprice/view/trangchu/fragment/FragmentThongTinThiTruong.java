...
public class FragmentThongTinThiTruong extends Fragment implements GridViewNewsAdapter.IGridViewNewsAdapter {
    ...
    public void onAttach(Activity activity) {
        ...
        newsList = ((MainActivity) activity).xuLyNews.getNewsListThongTinThiTruong();
    }

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.layout_thongtinthitruong, container, false);
        gridView = view.findViewById(R.id.gridview_thongtinthitruong);
