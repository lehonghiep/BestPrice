...
public class FragmentXuTheTieuDung extends Fragment implements GridViewNewsAdapter.IGridViewNewsAdapter{
    ...
    public void onAttach(Activity activity) {
        ...
        newsList = ((MainActivity) activity).xuLyNews.getNewsListXuTheTieuDung();
    }
    @Override
    public int getCount() {
        if(newsList==null){
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view=inflater.inflate(R.layout.layout_xuthetieudung,container,false);
        gridView = view.findViewById(R.id.gridview_xuthenguoitieudung);
