...
public class FragmentDienLanh extends Fragment implements GridViewNewsAdapter.IGridViewNewsAdapter{
    ...
    public void onAttach(Activity activity) {
        ...
        newsList = ((MainActivity) activity).xuLyNews.getNewsListDienLanh();
    }
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view=inflater.inflate(R.layout.layout_dienlanh,container,false);
        gridView = view.findViewById(R.id.gridview_dienlanh);
